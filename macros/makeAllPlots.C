...
void makeAllPlots()
{
  ...
  gROOT->ProcessLine(".L ../macros/my2DTaggingMethod_4x4_C.so");
  ...
  // With MC_TOT
  my2DTaggingMethod_4x4(ana._fMC_TOT,ana._fData,"MC_TOT_");
  
  // With MC_G
  my2DTaggingMethod_4x4(ana._fMC_G,ana._fData,"MC_G_");
  
  // With MC_QCD
  my2DTaggingMethod_4x4(ana._fMC_QCD,ana._fData,"MC_QCD_");
